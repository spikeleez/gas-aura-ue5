...
struct FAuraCharacterInfo
{
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, meta=(
		EditCondition="CharacterEditMode == EAuraEditCharDataMode::Minimal || CharacterEditMode == EAuraEditCharDataMode::Full",
		EditConditionHides))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, meta=(
		EditCondition="CharacterEditMode == EAuraEditCharDataMode::Full",
		EditConditionHides))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, meta=(
		EditCondition="CharacterEditMode == EAuraEditCharDataMode::Full",
		EditConditionHides))
	UAuraMovementData* CharacterMovementData = nullptr;
...
struct FAuraWeaponInfo
{
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, meta=(
		EditCondition="WeaponEditMode == EAuraEditCharDataMode::Minimal || WeaponEditMode == EAuraEditCharDataMode::Full",
		EditConditionHides))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, meta=(
		EditCondition="WeaponEditMode == EAuraEditCharDataMode::Full",
		EditConditionHides))
...
struct FAuraAnimationInfo
{
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, meta=(
		EditCondition="AnimationEditMode == EAuraEditCharDataMode::Minimal || AnimationEditMode == EAuraEditCharDataMode::Full",
		EditConditionHides))
	TSubclassOf<UAnimInstance> CharacterAnimClass = nullptr;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, meta=(
		EditCondition="AnimationEditMode == EAuraEditCharDataMode::Full",
		EditConditionHides))
...
struct FAuraAbilityInfo
{
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, meta=(
		EditCondition="AbilityEditMode == EAuraEditCharDataMode::Minimal || AbilityEditMode == EAuraEditCharDataMode::Full",
		EditConditionHides))
	UAuraAbilitySetData* AbilitySetData = nullptr;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, meta=(
		EditCondition="AbilityEditMode == EAuraEditCharDataMode::Full",
		EditConditionHides))
